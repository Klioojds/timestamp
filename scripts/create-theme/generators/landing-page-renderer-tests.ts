/**
 * Generate the landing page renderer unit test file (renderers/landing-page-renderer.test.ts).
 *
 * Creates Vitest tests covering landing page renderer mounting, animation state handling,
 * size updates, cleanup, and element counting.
 *
...
export function generateLandingPageRendererTestTs(themeName: string): string {
...
import { ${camel}LandingPageRenderer } from './landing-page-renderer';
import { createThemeTestContainer, mountLandingPageRenderer } from '../test-utils';

describe('${pascal} Landing Page Renderer', () => {
